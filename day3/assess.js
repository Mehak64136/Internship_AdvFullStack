...
// Q3 Object me greet() method add karo jo print kare: Hello I am Ram 

student.greet = function() {
  console.log(`Hello I am ${this.name}`);
};
student.greet(); // Output: Hello I am Ram
...
// Q8  Object me dynamically property add karo.  student.course = "MERN"; 
...
// Q13  Object me do methods banao:  deposit()  withdraw()  Aur balance update karo. 
...
// Q14 Predict Output const user = { name:"Ram", show(){ console.log(this.name); } }; user.show(); 
// Answer= Ram

// Q15 Predict Output const user = { name:"Ram", show: () => { console.log(this.name); } }; user.show();

// Answer= Undefined

// Q16 Student constructor function banao. Parameters: name age 
...
const student1 = new Student("Mehak", 20);
const student2 = new Student("Mohan", 25);
const student3 = new Student("Ram", 21);
...
// Q19 Predict Output function User(name){ this.name=name; } const u1=new User("Ram"); console.log(u1.name); 

// Answer == Ram


// Q20 Car constructor function banao. Properties: brand price
...
// Q24 Predict Output function User(){} User.prototype.sayHi=function(){ console.log("Hi"); } const u1=new User(); u1.sayHi(); 
...
// Q26 Check karo: u1.hasOwnProperty("course") Output kya hoga? 

// Output == false


// Q27 Check karo: "course" in u1 Output kya hoga? 

// true


// Q28 Prototype chain draw karo: const arr=[]

// Answer ==  arr -> Array.prototype -> Object.prototype -> null

// Q29 Animal object banao. Method: eat() 
...
// Q32 Predict Output const animal={ eat(){ console.log("Eating"); } }; const dog=Object.create(animal); dog.eat();

// Answer== Eating

// Q33 Student class banao. Properties: name age 
...
const student2 = new Student("Shyam", 17);
